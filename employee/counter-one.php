            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo SITEURL; ?>employee/queuing-done.php?queue_no=<?php echo $queue_no - 1; ?>"
                        class="btn-second" id="doneButton">Done</a>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        function disableOtherButtons(clickedButton) {
                            [callButton, serveButton, doneButton].forEach(function(button) {
                        ...
                        callButton.addEventListener('click', function() {
                            disableOtherButtons(callButton);
                        });

                        serveButton.addEventListener('click', function() {
                            disableOtherButtons(serveButton);
                        });

                        doneButton.addEventListener('click', function() {
                            disableOtherButtons(doneButton);
                        });
                    });
                    </script>
                </td>
