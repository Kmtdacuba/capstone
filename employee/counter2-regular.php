...
<section class="home-section">
    ...
    <div class="text">Regular Queue in Counter 2
    </div>
    ...
    <div class="text-center">
        ...
        <table class="table-full">
            ...
            <?php
                        $sql = "SELECT * FROM tbl_queuing WHERE age>1 AND age<59 AND counter_no = 2";
