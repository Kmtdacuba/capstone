...
<section class="home-section">
    ...
    <div class="text">Regular Queue in Counter 4
    </div>
    ...
    <div class="text-center">
        ...
        <a href="priority-counter4.php">
            <div class="queues text-center">
                <?php
                                $total_priority_query = "SELECT COUNT(*) AS total_priority FROM tbl_queuing WHERE age>=60 AND counter_no=4";
        ...
        <a href="counter4-regular.php">
            <div class="queues text-center">
                <?php
                                $total_regular_query = "SELECT COUNT(*) AS total_regular FROM tbl_queuing WHERE age>1 AND age<59 AND counter_no=4";
        ...
        <table class="table-full">
            ...
            <?php
                        $sql = "SELECT * FROM tbl_queuing WHERE age>1 AND age<59 AND counter_no = 4";
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo SITEURL; ?>employee/counter-call/counter4-call.php?queue_no=<?php echo $queue_no - 1; ?>"
                        class="btn-fifth">Call</a>

                    <a href="<?php echo SITEURL; ?>employee/counter-serve/counter4-serve.php?queue_no=<?php echo $queue_no - 1; ?>"
                        class="btn-third">Serve</a>

                    <a href="<?php echo SITEURL; ?>employee/counter-done/counter4-done.php?queue_no=<?php echo $queue_no - 1; ?>"
