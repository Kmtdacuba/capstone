...
<section class="home-section">
    ...
    <section class="search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL;?>employee/residents.php" method="POST">
    ...
    <a href="<?php echo SITEURL; ?>employee/register.php" class="btn-primary">Add Resident</a>
    <br><br><br>
    <?php 
    ...
    <table class="table-full">
        ...
        <div class="menu-box">
            <tr>
                ...
                <td>
                    <a href="<?php echo SITEURL;?>employee/update-resident.php?id=<?php echo $id;?>"
                        class="btn-second">Update</a>
                    <a href="<?php echo SITEURL;?>employee/delete-resident.php?id=<?php echo $id;?>"
